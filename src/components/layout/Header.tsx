    ...
    >
      <div className="container flex items-center justify-between">
        ...
        <div className="hidden md:flex md:items-center md:space-x-6">
          ...
          <HoverCard key="latest" openDelay={100} closeDelay={100}>
            <HoverCardTrigger asChild>
              <Link 
                to="/latest" 
                className={cn(
                  "text-sm transition-all duration-300 relative",
                  activeSection === "latest" || location.pathname === "/latest"
                    ? "text-fakexpose-blue font-medium" 
                    : "text-white hover:text-fakexpose-blue",
                  "after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-fakexpose-blue after:origin-bottom-right after:transition-transform after:duration-300",
                  (activeSection === "latest" || location.pathname === "/latest") ? "after:scale-x-100" : "hover:after:scale-x-100 hover:after:origin-bottom-left"
                )}
              >
                Latest
              </Link>
            ...
            <HoverCardContent className="p-3 text-xs glass-panel border-fakexpose-blue/20">
              <p>View latest fact check stories from around the world</p>
            </HoverCardContent>
          </HoverCard>

          {[
            { id: "politics", label: "News & Politics", path: "/news" },
            { id: "factcheck", label: "Fact Check", path: null },
            { id: "quiz", label: "Quiz", path: null },
            { id: "feedback", label: "Feedback", path: null }
          ].map(({ id, label, path }) => (
              ...
              <HoverCardTrigger asChild>
                {path ? (
                  <Link 
                    ...
                    className={cn(
                      "text-sm transition-all duration-300 relative",
                      activeSection === id || location.pathname === path
                        ? "text-fakexpose-blue font-medium" 
                        : "text-white hover:text-fakexpose-blue",
                      "after:content-[''] after:absolute after:w-full after:scale-x-0 after:h-0.5 after:bottom-0 after:left-0 after:bg-fakexpose-blue after:origin-bottom-right after:transition-transform after:duration-300",
                      (activeSection === id || location.pathname === path) ? "after:scale-x-100" : "hover:after:scale-x-100 hover:after:origin-bottom-left"
                    )}
                  >
                    {label}
                  </Link>
        ...
        <nav className="flex flex-col space-y-4">
          <Link 
            ...
            className={cn(
              ...
              activeSection === "trending" || location.pathname === "/trending"
                ? "text-fakexpose-blue font-medium" 
                : "text-white hover:text-fakexpose-blue"
            )}
